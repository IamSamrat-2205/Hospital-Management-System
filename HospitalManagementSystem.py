...
def pd():
    if e1.get()=="" or e2.get()=="":
        ...
        con=mysql.connector.connect(host="localhost",username="root",password="Samrat@2205",database="mydata")
...
lf2=LabelFrame(frame1,text='Prescription',font='ariel 12 bold',bd=10,bg='pink')
